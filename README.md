...
- Clone this repo ```git clone https://github.com/devtea2028/dicta-perspiciatis-vero-earum.git```.
...
You can see an example of using addons please see [this](https://github.com/devtea2028/dicta-perspiciatis-vero-earum/blob/master/example/src/examples/Addons.js) file in the example folder.
...
If you have any feature requests or have any issues please post them [here](https://github.com/devtea2028/dicta-perspiciatis-vero-earum/issues).

## Contributing

If you would like to contribute to this project in terms of code please see our [contributing](https://github.com/devtea2028/dicta-perspiciatis-vero-earum/blob/master/CONTRIBUTING.md) page.
...
Distributed under the MIT License. See [LICENSE](https://github.com/devtea2028/dicta-perspiciatis-vero-earum/blob/master/LICENSE) for more information.
